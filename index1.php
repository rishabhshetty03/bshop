...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    ...
    <ul id="topMenu" class="nav pull-right">
	 ...
	 <li class="">
	 <a type="button" href="../web/index.html" style="padding-right:0"><span class="btn btn-large btn-success">Logout</span></a>
...
<!--path should be given in form to pass the valuesof username n pass-->
	<form class="form-horizontal loginFrm" method="post" action="login.php">
		...
		<a href="login.php"><button type="submit" class="btn btn-success">Sign in</button></a>
...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
		  ...
		  <div class="container">
			<a href="#mainBody"><img style="width:100%" src="themes/images/carousel/1a.png" alt="special offers"/></a>
		  ...
		  <div class="item">
		  <div class="container">
			<a href="#mainBody"><img style="width:100%" src="themes/images/carousel/2a.png" alt=""/></a>
				<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
		  ...
		  <div class="item">
		  <div class="container">
			<a href="#mainBody"><img src="themes/images/carousel/3a.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
		   ...
		   <div class="item">
		   <div class="container">
			<a href="#mainBody"><img src="themes/images/carousel/4a.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
		   ...
		   <div class="item">
		   <div class="container">
			<a href="#mainBody"><img src="themes/images/carousel/5a.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
			</div>
		   ...
		   <div class="item">
		   <div class="container">
			<a href="#mainBody"><img src="themes/images/carousel/6a.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
